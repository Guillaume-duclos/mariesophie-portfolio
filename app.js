...
*/
(function(f,h){ true?module.exports=h("Pageable"):"function"===typeof define&&define.amd?define([],h):f.Pageable=h("Pageable")})("undefined"!==typeof global?global:this.window||this.global,function(){var f=function(){},h=function b(a,c){for(var g in c)if(c.hasOwnProperty(g)){var d=c[g];d&&"[object Object]"===Object.prototype.toString.call(d)?(a[g]=a[g]||{},b(a[g],d)):a[g]=d}return a},m=function(a,c,b){var d;return function(){b=b||this;if(!d)return a.apply(b,arguments),d=!0,setTimeout(function(){d=
    !1},c)}},k=function(a){this.instance=a;this.running=!1;this.config=this.instance.config.slideshow};k.prototype.start=function(){var a=this;a.running||(a.running=!0,a.instance.slideIndex=a.instance.index,a.instance.interval=setInterval(function(){a.instance.config.onBeforeStart.call(a.instance,a.instance.slideIndex);setTimeout(function(){a.instance.config.infinite&&a.instance._overScroll(!0);a.instance.index<a.instance.pages.length-1?a.instance.slideIndex++:a.instance.slideIndex=0;a.instance.scrollToIndex(a.instance.slideIndex)},
    a.config.delay||0)},a.config.interval))};k.prototype.stop=function(){this.running&&(clearInterval(this.instance.interval),this.running=this.instance.slideInterval=!1)};var d=function(a,c){if(void 0===a)return console.error("Pageable:","No container defined.");var b=this,d={pips:!0,animation:300,delay:0,throttle:50,orientation:"vertical",easing:function(a,b,c,d,g){return-c*(a/=d)*(a-2)+b},onInit:f,onUpdate:f,onBeforeStart:f,onStart:f,onScroll:f,onFinish:f,swipeThreshold:50,freeScroll:!1,slideshow:!1,
    infinite:!1,events:{wheel:!0,mouse:!0,touch:!0}};this.container="string"===typeof a?document.querySelector(a):a;if(!this.container)return console.error("Pageable:","The container could not be found.");this.config=h(d,c);this.events=this.config.events;if(this.config.anchors&&Array.isArray(this.config.anchors)){var l=document.createDocumentFragment();this.config.anchors.forEach(function(a){var b=document.createElement("div");b.dataset.anchor=a;l.appendChild(b)});this.container.appendChild(l)}this.pages=
    this.container.querySelectorAll("[data-anchor]");if(!this.pages.length)return console.error("Pageable:","No child nodes with the [data-anchor] attribute could be found.");this.horizontal="horizontal"===this.config.orientation;this.anchors=[];this.pages.forEach(function(a,c){var d=a.dataset.anchor.replace(/\s+/,"-").toLowerCase();a.id!==d&&(a.id=d);b.anchors.push("#"+d);a.classList.add("pg-page");a.classList.toggle("pg-active",0==c)});this.axis=this.horizontal?"x":"y";this.mouseAxis={x:"clientX",y:"clientY"};
    ...
    b=document.createElement("ul");c.classList.add("pg-pips");this.pages.forEach(function(a,c){var d=document.createElement("li"),g=document.createElement("a"),e=document.createElement("span");g.href="#"+a.id;0==c&&g.classList.add("active");g.appendChild(e);d.appendChild(g);b.appendChild(d)});c.appendChild(b);this.wrapper.appendChild(c);this.pips=Array.from(b.children)}this.pageCount=this.pages.length;this.lastIndex=this.pageCount-1;a.infinite&&this._toggleInfinite();this.bind();this.update();this._load();
    c=this._getData();this.config.onInit.call(this,c);this.emit("init",c);this.initialised=!0;this.container.pageable=this;a.slideshow&&"function"===typeof k&&(this.slider=new k(this),this.slider.start())}};d.prototype.bind=function(){this.callbacks={wheel:this._wheel.bind(this),update:m(this.update.bind(this),this.config.throttle),load:this._load.bind(this),start:this._start.bind(this),drag:this._drag.bind(this),stop:this._stop.bind(this),click:this._click.bind(this),prev:this.prev.bind(this),next:this.next.bind(this),
    ...
    b.emit("scroll.start",b._getData());b.frame=requestAnimationFrame(function n(){var e=Date.now()-d;if(e>b.config.animation)return cancelAnimationFrame(b.frame),b.container.style.transform="",b.frame=!1,b.scrolling=!1,b.dragging=!1,b.config.slideshow&&b.slider.start(),b.config.infinite&&(c===b.pageCount?b.index=0:-1===c&&(b.index=b.lastIndex)),e=b._getData(),window.location.hash=b.pages[b.index].id,b.pages.forEach(function(a,c){a.classList.toggle("pg-active",c===b.index)},b),b.slideIndex=b.index,b._setPips(),
    b._setNavs(),b.config.onFinish.call(b,e),b.emit("scroll.end",e),!1;e=b.config.easing(e,b.dragging?b.dragging:0,a,b.config.animation);b.container.style.transform=b.horizontal?"translate3d("+e+"px, 0, 0)":"translate3d(0, "+e+"px, 0)";b.scrollPosition=f[b.axis]-e;e=b._getData();b.config.infinite&&(c===b.pageCount?e.scrolled=0:-1===c&&(e.scrolled=e.max));b.config.onScroll.call(b,e);b.emit("scroll",e);b.frame=requestAnimationFrame(n)})},b.dragging?0:b.config.delay)};d.prototype._getScrollOffset=function(){return{x:this.wrapper.scrollLeft,
    y:this.wrapper.scrollTop}};d.prototype._getScrollAmount=function(a,c){void 0===c&&(c=this.index);var b=this.data.window[this.size[this.axis]];return b*a-b*c};d.prototype._getScrollBarWidth=function(){var a=document.body,c=document.createElement("div"),b=0;return c.style.cssText="width: 100; height: 100; overflow: scroll; position: absolute; top: -9999;",a.appendChild(c),b=c.offsetWidth-c.clientWidth,a.removeChild(c),b};d.prototype._toggleInfinite=function(a){if(a&&this.config.infinite)this.clones.forEach(function(a){this.container.removeChild(a)},
    this),this.config.infinite=!1;else if(!this.config.infinite){this.config.infinite=!0;a=this.pages[0].cloneNode(!0);var c=this.pages[this.lastIndex].cloneNode(!0);a.id+="-clone";c.id+="-clone";a.classList.add("pg-clone");c.classList.add("pg-clone");a.classList.remove("pg-active");c.classList.remove("pg-active");this.clones=[a,c];this.container.insertBefore(c,this.pages[0]);this.container.appendChild(a)}this.update()};d.prototype._limitDrag=function(a){a=a[this.mouseAxis[this.axis]]-this.down[this.axis];
...
/*! lazysizes - v4.1.4 */
!function(a,b){var c=function(){b(a.lazySizes),a.removeEventListener("lazyunveilread",c,!0)};b=b.bind(null,a,a.document),"object"==typeof module&&module.exports?b(__webpack_require__(4)):a.lazySizes?c():a.addEventListener("lazyunveilread",c,!0)}(window,function(a,b,c){"use strict";function d(a,c){if(!g[a]){var d=b.createElement(c?"link":"script"),e=b.getElementsByTagName("script")[0];c?(d.rel="stylesheet",d.href=a):d.src=a,g[a]=!0,g[d.src||d.href]=!0,e.parentNode.insertBefore(d,e)}}var e,f,g={};b.addEventListener&&(f=/\(|\)|\s|'/,e=function(a,c){var d=b.createElement("img");d.onload=function(){d.onload=null,d.onerror=null,d=null,c()},d.onerror=d.onload,d.src=a,d&&d.complete&&d.onload&&d.onload()},addEventListener("lazybeforeunveil",function(a){if(a.detail.instance==c){var b,g,h,i;a.defaultPrevented||("none"==a.target.preload&&(a.target.preload="auto"),b=a.target.getAttribute("data-link"),b&&d(b,!0),b=a.target.getAttribute("data-script"),b&&d(b),b=a.target.getAttribute("data-require"),b&&(c.cfg.requireJs?c.cfg.requireJs([b]):d(b)),h=a.target.getAttribute("data-bg"),h&&(a.detail.firesLoad=!0,g=function(){a.target.style.backgroundImage="url("+(f.test(h)?JSON.stringify(h):h)+")",a.detail.firesLoad=!1,c.fire(a.target,"_lazyloaded",{},!0,!0)},e(h,g)),i=a.target.getAttribute("data-poster"),i&&(a.detail.firesLoad=!0,g=function(){a.target.poster=i,a.detail.firesLoad=!1,c.fire(a.target,"_lazyloaded",{},!0,!0)},e(i,g)))}},!1))});
...
var _pageable = __webpack_require__(3);
...
(0, _domready2.default)(function () {
  ...
  var magicController = new _scrollmagic2.default.Controller();
  var isDesktop = window.matchMedia('screen and (min-width: 992px)').matches;

  if (about) {
    if (isDesktop) {
      new _pageable2.default('#container', {
        animation: 500,
        swipeThreshold: 200
      });
    }
    ...
    var footerBreakpoint = about.querySelector('footer');
    var aside = about.querySelector('aside#menu');
    var pips = about.querySelector('.pg-pips');
...
(0, _domready2.default)(function () {
  ...
  if (home) {
    ...
    var footerBreakpoint = home.querySelector('footer');
    var aside = home.querySelector('aside#menu');
    var pips = home.querySelector('.pg-pips');
...
(0, _domready2.default)(function () {
  ...
  if (projetPages) {
    ...
    var footerBreakpoint = projetPages.querySelector('footer');
    var aside = projetPages.querySelector('aside#menu');
    var pips = projetPages.querySelector('.pg-pips');
...
(0, _domready2.default)(function () {
  ...
  if (projets) {
    ...
    var footerBreakpoint = projets.querySelector('footer');
    var aside = projets.querySelector('aside#menu');
    var pips = projets.querySelector('.pg-pips');
